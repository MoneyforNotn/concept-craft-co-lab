          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="min-h-[400px] max-h-none text-lg leading-relaxed bg-white border border-border/30 rounded-3xl shadow-sm px-6 py-8 focus-visible:ring-1 focus-visible:ring-ring/50 resize-none overflow-y-hidden font-sans"
